...
function showCongcu(obj, checked) {
    /*alert(obj);
    if(getObj('idsupport' + obj.value)!=null){
       if(trim(getObj('idsupport' + obj.value).innerHTML)==''){
            postAjax('support','idsupport' + obj.value,anchor + ':_LIST_SUPPORT_TYPE:id:'+obj.value);
            hideshow('idsupport' + obj.value,obj.checked);
        }else{
            hideshow('idsupport' + obj.value,obj.checked);
        }
    }*/
